          ...
          <div className="joinBody">
            <div className="formControl">
              ...
              {joinError.registerNickname && (
                <small className="error">{joinError.registerNickname}</small>
              )}
            ...
            <div className="formControl">
              ...
              {joinError.registerEmail && (
                <small className="error">{joinError.registerEmail}</small>
              )}
              <button className="checkButton" onClick={emailCheck}>
                중복확인
              </button>
            </div>
            <div className="formControl">
              ...
              {joinError.registerPassword && (
                <small className="error">{joinError.registerPassword}</small>
              )}
            </div>
          </div>
        </form>
        <div className="joinBtnPlace">
          <button className="joinButton" type="submit" onClick={joinBtn}>
            가입하기
          </button>
        </div>
